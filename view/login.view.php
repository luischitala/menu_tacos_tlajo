			...
			<div class="col-8 d-flex" style="padding-top: 40px;">
				<div class="col-6">
				  ...
				  <div class="form-group" class="formulario" name="login">
				    ...
				    <input type="text" class="form-control nombre" name="nombre" placeholder="Usuario">
				 ...
				 <?php if(!empty($errores)): ?>
				  ...
				  <?php endif; ?>
					...
					<p>
						...
						<a href="registrate.php" style="color:white; font-size: 20px; padding-left: 150px;">Regístrate</a>
					</p>
				</div>
