	...
	<div class="container-fluid main" style="background:#53687e; height: 525px; ">
		<div class="row justify-content-center" style="padding-top:10px;">
			...
			<div class="col-8 d-flex" style="padding-top: 40px;">
				<div class="col-6">
					<form action="<?php echo htmlspecialchars($_SERVER['PHP-SELF']); ?>" method="POST" name="login" class="formulario">
				  <div class="form-group" class="formulario" name="login">
				    ...
				    <input type="text" class="form-control usuario" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Usuario">
				<!--     <small id="emailHelp" style="color:white;" >No ingrese con un usuario que no sea suyo</small> -->
				  ...
				  <div class="form-group">
				    ...
				    <input type="password" class="form-control password" name="password" id="exampleInputPassword1" placeholder="Contraseña" >
				  </div>
				  ...
				  <button type="submit" class="btn btn-primary" onclick="login.submit()">Iniciar sesión</button>
					</form>
					<p>
						<h4 style="color:white; text-align: center;">¿No tienes cuenta?</h4>
						<a href="login.php" style="color:white; font-size: 20px; padding-left: 150px;">Regístrate</a>
					</p>
				</div>
